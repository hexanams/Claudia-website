...
const Steps = () => {
    ...
    return (
        <>
            <section className='px-16 py-20 bg-'>
                <div className='flex flex-col gap-6 justify-center items-center '>
                    <h1 className='font-extrabold text-5xl text-center'>Take the First Step Today</h1>
                    <p className='text-lg text-[#131313] font-light text-center'>Your journey to mental well-being starts here. Reach out now to schedule your appointment or learn more about our services.</p>
            ...
            <section className="py-20 px-16 flex flex-col gap-20">
                    ...
                    {steps.map((step, i) => (
                        <div key={i}>
                            ...
                            <div className="px-6 mt-6 mb-4">
                                ...
                                <p className="font-light text-xl">{step.description}</p>
                                <h3 className="text-[#C7C2BE] text-xl font-light">Book an consultation</h3>
                            </div>

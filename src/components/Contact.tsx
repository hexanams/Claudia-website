    ...
    <section className="p-3 md:px-5 lg:px-[100px] pt-[7px] pb-[53px] bg-[#EEECEB]">
      <div className="p-2 bg-white md:px-[54px] md:py-[51px]">
        ...
        >
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <motion.p className="font-light text-base text-[#939393] line-clamp-3">
                We are here to support you on your journey to emotional
                wellness. Whether you have questions, need more information or
                are ready to book your first session, don’t forget to reach out.
                We’d love to hear from you.
              </motion.p>
            </div>

            <motion.div
              className="relative flex justify-center lg:w-fit h-fit"
          ...
          >
            <div className="font-canela font-extrabold text-2xl text-[#B6B6B6] mb-2">
        ...
        <div className="w-full flex justify-center mt-13">
          <motion.div
            ...
            variants={fadeIn()}
          >
            <div className="font-canela text-3xl text-[#939393]">
              Reach Out to Us
            </div>
            <p className="mt-[10px] text-[#5C5C5C] text-center">
        ...
        <Form {...form}>
          <form className="w-full" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              {[
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="font-grotesk text-sm text-[#939393] md:text-base">
                          {label}
                        </FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            className="w-full lg:max-w-[291px] h-[56px] py-[10px] px-4 text-[#B6B6B6] border rounded-[8px]"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-grotesk text-[#939393] md:text-base">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Textarea
                      className="w-full border text-[#B6B6B6]"
                      {...field}
            ...
            >
              <Button
                type="submit"
                className="h-14 bg-[#C99D86] hover:bg-[#d8bdaf] w-full md:w-[361px] py-2 px-5 text-white font-sweet-sans"
              >
                Send Message
              </Button>
            </motion.div>

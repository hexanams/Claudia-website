const Issues = () => {
  ...
  return (
    <section className="p-5 lg:py-10 lg:px-[100px] bg-[url('/issues-bg.svg')] w-full bg-cover bg-center bg-no-repeat">
      <div className=" font-canela text-3xl md:text-5xl font-extrabold text-center text-[#C99D85]">
        Issues I Treat
      </div>
      ...
      <div className="mt-11 flex flex-col gap-6">
        <p className="text-[#666666] text-lg">
          Can&apos;t see exactly what you are looking for help with? Don&apos;t
          worry anything that is causing you distress you can bring to therapy,
          and I would still see this as important.
        </p>
      </div>
    </section>
  );
